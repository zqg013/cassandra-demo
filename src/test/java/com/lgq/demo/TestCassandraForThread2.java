...
/**
 * Created by alone on 2015/4/24.
 */
public class TestCassandraForThread2 {
    ...
    public TestCassandraForThread2() {
    }

    public TestCassandraForThread2(String threadName) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < count; i++) {
            executorService.execute(new TestCassandraForThread2("thread" + i).new Task(cyclicBarrier));
        }
